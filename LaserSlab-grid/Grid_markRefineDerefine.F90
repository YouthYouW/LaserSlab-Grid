...
subroutine Grid_markRefineDerefine()
  ...
  use Grid_data, ONLY : gr_refine_cutoff, gr_derefine_cutoff,&
                        ...
                        gr_eosModeNow
  use tree, ONLY : newchild, refine, derefine, stay, nodetype!, SPECIALBLOCK
  use Simulation_data, ONLY: criterion, size, specs, lref, sim_useRefineSpecialized
...
!!$  force_consistency = .TRUE.
 ...
 ! SPECIALBLOCK(:) = .FALSE.
  ...
  if (sim_useRefineSpecialized) then
    call Grid_markRefineSpecialized(criterion,size,specs,lref)
  end if
